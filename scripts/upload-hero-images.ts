...
async function main() {
  ...
  const khtpCdnUrl = await uploadFile('public/images/khtp.webp', 'hero/khtp.webp', 'image/webp');
  const tpmCdnUrl = await uploadFile('public/images/tpm.webp', 'hero/tpm.webp', 'image/webp');
