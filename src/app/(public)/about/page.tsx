      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 space-y-16">
        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm space-y-4">
            <div className="rounded-lg bg-accent p-2.5 text-primary inline-block">
              <Award className="h-6 w-6" />
            </div>
            <h3 className="font-heading text-md font-bold text-foreground">National Accreditation</h3>
          ...
          <div className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm space-y-4">
            ...
            <h3 className="font-heading text-md font-bold text-foreground">Applied Deep Tech</h3>
            <p className="text-xs text-slate-500 leading-relaxed">
          ...
          <div className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm space-y-4">
            ...
            <h3 className="font-heading text-md font-bold text-foreground">B2B Co-Design</h3>
            <p className="text-xs text-slate-500 leading-relaxed">
