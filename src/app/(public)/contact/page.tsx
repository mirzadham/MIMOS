      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8 space-y-16">
        ...
        <div className="grid grid-cols-1 gap-10 lg:grid-cols-3 items-start">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            {/* Info panel */}
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 rounded-3xl border border-slate-200 bg-white p-6 sm:p-8 shadow-neon-light">
              ...
              <div className="rounded-2xl bg-slate-50/50 p-6 border border-slate-200/80 space-y-4 font-body">
            ...
            <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-neon-light">
              ...
              <div className="relative h-60 rounded-2xl overflow-hidden border border-slate-200 bg-slate-50 flex flex-col items-center justify-center text-slate-400">
          ...
          <div className="rounded-3xl border border-slate-200 bg-white p-6 sm:p-8 shadow-neon-light space-y-6">
            ...
            <form className="space-y-4 text-xs font-body" onSubmit={(e) => e.preventDefault()}>
              <div className="space-y-1.5">
                ...
                <input 
                  ...
                  className="w-full rounded-xl border border-slate-250 bg-white px-4 py-2.5 text-xs font-semibold focus:border-primary focus:outline-none focus:ring-2 focus:ring-primary/10 transition-all text-slate-800 placeholder-slate-400"
                />
              </div>
              ...
              <button
                type="submit"
                className="w-full flex items-center justify-center gap-1.5 rounded-xl bg-primary hover:bg-primary-hover text-white py-4 text-xs font-bold transition-all cursor-pointer shadow-sm hover:shadow-neon-hover"
              >
