...
export default function WhyChooseUs() {
  ...
  return (
    <section className="border-b border-slate-200/60 bg-slate-50/30 py-20 sm:py-28 relative overflow-hidden">
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        >
          ...
          <motion.div 
            ...
            className="group md:col-span-2 relative rounded-2xl border border-slate-200/80 bg-white p-8 sm:p-10 hover:border-primary/20 hover:shadow-neon-hover transition-all duration-300 flex flex-col justify-between overflow-hidden"
          >
            <div className="absolute right-0 top-0 -mt-4 -mr-4 h-32 w-32 rounded-full bg-slate-50 group-hover:bg-primary/5 transition-colors duration-300 pointer-events-none" />
            <div className="space-y-5 max-w-2xl">
              <div className="inline-flex h-11 w-11 items-center justify-center rounded-xl bg-primary/5 border border-primary/10 text-primary">
            ...
            <div className="mt-8 pt-6 border-t border-slate-100 flex flex-wrap gap-2">
              {["C Programming", "Python", "Semiconductor Cleanroom Labs", "Advanced Math", "5G Edge Architecture"].map((badge, idx) => (
                <span 
                  key={idx}
                  className="inline-flex items-center rounded-full bg-slate-50 border border-slate-200/60 px-3 py-1 text-xs font-bold text-slate-600 group-hover:border-primary/10 group-hover:bg-primary/5 group-hover:text-primary transition-all duration-300"
                >
                  {badge}
                </span>
              ))}
          ...
          <motion.div 
            variants={itemVariants}
            className="group relative rounded-2xl border border-slate-200/80 bg-white p-8 hover:border-primary/20 hover:shadow-neon-hover transition-all duration-300 flex flex-col justify-between"
          >
