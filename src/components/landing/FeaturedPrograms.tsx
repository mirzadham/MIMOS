      ...
      <div className="mx-auto max-w-7xl px-6 py-20 sm:px-8 sm:py-28 relative">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 border-b border-slate-200/80 pb-10">
          <div className="space-y-3 max-w-3xl">
            <div className="inline-flex items-center gap-1.5 rounded-none bg-primary/5 px-3 py-1 text-xs font-bold text-primary border border-primary/10">
          ...
          <div className="shrink-0">
            <Link
              href="/programs"
              className="inline-flex items-center justify-center gap-1.5 rounded-none bg-slate-900 px-6 py-3.5 text-xs font-bold text-white hover:bg-primary transition-all duration-200 group"
            >
