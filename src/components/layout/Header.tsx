      ...
      <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center">
          <Link href="/" className="flex items-center gap-2 group">
            <GraduationCap className="h-8 w-8 text-primary group-hover:text-teal transition-colors duration-300" />
            <div className="flex flex-col">
              <span className="font-heading text-lg font-bold tracking-tight text-dark-pine leading-none">
                MIMOS
              </span>
              <span className="font-sans text-xs font-semibold tracking-widest text-primary group-hover:text-teal transition-colors duration-300 uppercase">
                Academy
              </span>
            </div>
          </Link>
        ...
        <div className="hidden md:flex items-center gap-4">
          ...
          <Link
            href="/admin"
            className="rounded-md bg-gradient-to-r from-primary to-teal text-white hover:from-primary-hover hover:to-teal-hover hover:shadow-md px-4 py-2 text-xs font-bold transition-all"
          >
            Admin Panel
          </Link>
        </div>
        ...
        <div className="flex md:hidden items-center gap-3">
          <Link
            href="/admin"
            className="rounded-md bg-gradient-to-r from-primary to-teal text-white px-3 py-1.5 text-xs font-bold"
          >
            Portal
          </Link>
          <button
      ...
      {searchOpen && (
        <div className="absolute top-16 left-0 w-full border-b border-slate-200 bg-white p-4 shadow-md z-40">
          <div className="mx-auto max-w-3xl flex gap-2">
            ...
            />
            <button className="rounded-md bg-gradient-to-r from-primary to-teal hover:from-primary-hover hover:to-teal-hover px-4 py-2 text-sm font-bold text-white transition-all cursor-pointer">
              Search
            </button>
            <button 
